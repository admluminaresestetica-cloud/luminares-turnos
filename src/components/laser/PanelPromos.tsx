        ...
        return (
          ...
          >
              ...
              <div className="flex justify-between items-start gap-4">
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-2.5 text-xs text-slate-500">
                    ...
                    {promo.permite_swap && (
                      <span className="inline-flex items-center gap-1 text-emerald-700 bg-emerald-50 border border-emerald-200/60 px-2 py-0.5 rounded-md text-[11px] font-semibold">
                ...
                <div className="text-right shrink-0 flex items-center gap-3">
                  <div>
                    <p className="font-bold text-slate-900 text-lg md:text-xl tracking-tight">
            ...
            {seleccionada && zonasPromo.length > 0 && (
              <div className="px-4 pb-4 md:px-5 md:pb-5 border-t border-slate-100 bg-slate-50/50 pt-4 space-y-2">
                ...
                {promo.zonas_incluidas.map((zonaId) => {
                  ...
                  return (
                    <div
                      key={zonaId}
                      className="flex items-center justify-between bg-white rounded-xl px-3.5 py-2.5 border border-slate-200/60 shadow-2xs"
                    >
                      <div>
                      ...
                      {promo.permite_swap && original && (
                        <button
                          ...
                          className="inline-flex items-center gap-1 text-xs font-semibold text-slate-700 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 px-2.5 py-1.5 rounded-lg transition-colors"
                        >
            ...
            {seleccionada && zonasPromo.length === 0 && promo.zonas_incluidas.length === 0 && (
              <div className="px-5 pb-4 text-xs text-amber-600 bg-amber-50/50 pt-3 border-t border-amber-100">
