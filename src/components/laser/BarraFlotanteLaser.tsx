      ...
      <div className="max-w-3xl mx-auto pointer-events-auto">
        <div className="bg-slate-900/95 backdrop-blur-md text-white rounded-2xl shadow-2xl border border-slate-800 p-3.5 sm:px-5 sm:py-4 flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="shrink-0 inline-flex items-center justify-center gap-1.5 sm:gap-2 bg-white hover:bg-slate-100 active:scale-95 disabled:opacity-50 disabled:bg-slate-800 disabled:text-slate-500 text-slate-900 font-bold px-4 sm:px-5 py-2.5 sm:py-3 rounded-xl transition-all text-xs sm:text-sm shadow-sm cursor-pointer"
          >
            <span>Continuar</span>
