        ...
        <div className="max-w-2xl mx-auto px-4 space-y-5">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5">
            <a
              ...
              className="group inline-flex items-center gap-1.5 whitespace-nowrap text-xs font-medium text-slate-600 hover:text-slate-900 bg-white px-3.5 py-2 rounded-full border border-slate-200 shadow-xs hover:shadow-md hover:border-rose-200 transition-all duration-200 active:scale-95"
            >
            ...
            <button
              ...
              className="group inline-flex items-center gap-1.5 whitespace-nowrap text-xs font-medium text-slate-600 hover:text-slate-900 bg-white px-3.5 py-2 rounded-full border border-slate-200 shadow-xs hover:shadow-md hover:border-emerald-200 transition-all duration-200 cursor-pointer active:scale-95"
            >
          ...
          <div className="relative w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-2xl bg-white shadow-2xl text-left text-slate-800 text-sm border border-slate-100">
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-100 bg-white/95 backdrop-blur-sm px-6 py-4">
              ...
              <button
                ...
                className="rounded-full p-1.5 text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition-all active:scale-90"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="sticky bottom-0 bg-white/95 backdrop-blur-sm border-t border-slate-100 px-6 py-4 text-right">
              <button
                type="button"
                onClick={() => setModalPoliticasAbierto(false)}
                className="px-5 py-2.5 bg-slate-900 text-white rounded-xl text-xs font-semibold hover:bg-slate-800 shadow-sm hover:shadow-md transition-all active:scale-95"
              >
                Entendido
              </button>
            </div>
