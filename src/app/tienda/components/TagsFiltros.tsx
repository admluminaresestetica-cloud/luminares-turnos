    ...
    <div className="w-full overflow-x-auto no-scrollbar py-3 mb-3">
      <div className="flex items-center gap-3 px-1">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center min-w-[76px] h-[76px] p-2 rounded-2xl transition-all duration-150 shrink-0 cursor-pointer border active:scale-95 ${
        ...
        >
          <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 ${
            tagSeleccionado === null ? 'bg-white/15 text-white' : 'bg-[#F7F7F5] text-[#0E6E55]'
          }`}>
        ...
        {tags.map((tag) => {
          ...
          return (
            ...
            >
              <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 ${
                estaActivo ? 'bg-white/15 text-white' : 'bg-[#F7F7F5] text-[#0E6E55]'
              }`}>
                <Tag className="w-4 h-4" />
              </div>
              <span className="text-[11px] font-bold tracking-tight text-center truncate w-full">
