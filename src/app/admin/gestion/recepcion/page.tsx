...
export default function RecepcionPage() {
  ...
  const handleEnviarAGabinete = async () => {
    ...
    // Insertar nueva sesión en sesiones_gabinete con estado "en_espera"
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-slate-500 text-sm">Gestiona el ingreso de clientes y envíalos a la sala de espera de gabinete.</p>
      </div>
