  ...
  return (
    <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-4 sm:p-6 transition-all">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div className="flex space-x-1.5 sm:space-x-2 bg-gray-100/80 p-1.5 rounded-2xl overflow-x-auto">
          <button
                    ...
                    >
                      <td className="px-3 sm:px-4 py-3.5 font-bold text-gray-900 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <span className={`w-2 h-2 rounded-full shrink-0 ${esMasculino ? 'bg-blue-500' : 'bg-rose-500'}`} />
                          {serv.nombre_zona || '-'}
                        </div>
                      </td>
                      ...
                      <td className="px-3 sm:px-4 py-3.5 text-gray-500 font-medium capitalize whitespace-nowrap">
                        {serv.categoria_zona || '-'}
                      </td>
                ...
                {promos.map((p) => {
                  ...
                  return (
                    <tr key={p.id} className="hover:bg-gray-50/60 transition-colors">
                      ...
                      <td className="px-3 sm:px-4 py-3.5 font-extrabold text-emerald-600 text-sm whitespace-nowrap">
                        ${(p.precio_promo || 0).toLocaleString('es-AR')}
                      </td>

                      <td className="px-3 sm:px-4 py-3.5 font-medium text-gray-600 whitespace-nowrap">
                        {p.permite_swap ? (
