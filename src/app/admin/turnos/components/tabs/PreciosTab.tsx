  ...
  return (
    <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-4 sm:p-6 transition-all dark:bg-zinc-900 dark:border-zinc-800">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div className="flex space-x-1.5 sm:space-x-2 bg-gray-100/80 p-1.5 rounded-2xl overflow-x-auto dark:bg-zinc-800">
          <button
            onClick={() => setSeccionPrecios('servicios')}
            className={`whitespace-nowrap px-3 sm:px-4 py-2 text-xs font-bold rounded-xl transition-all flex items-center gap-1.5 ${
              ...
              <tbody className="divide-y divide-gray-50 dark:divide-zinc-800">
                {servicios.map((serv) => {
                  ...
                  return (
                    <tr 
                      key={serv.id} 
                      className={`transition-colors border-l-4 dark:hover:bg-zinc-850/50 ${
                        esMasculino 
            ...
            <table className="min-w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-gray-50 dark:divide-zinc-800">
                {promos.map((p) => {
                  ...
                  return (
                    <tr key={p.id} className="hover:bg-gray-50/60 transition-colors dark:hover:bg-zinc-850/50">
                      <td className="px-3 sm:px-4 py-3.5 font-bold text-gray-900 whitespace-nowrap dark:text-zinc-100">
                        {p.nombre_promo || '-'}
                      </td>
