...
export default function GeneralesTab({
  ...
  return (
    <div className="space-y-6">
              ...
              <table className="min-w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-gray-50 dark:divide-zinc-800">
                  {serviciosGenerales.map((serv) => (
                    <tr key={serv.id} className="hover:bg-gray-50/60 transition-colors dark:hover:bg-zinc-850/50">
                      ...
                      <td className="px-3 sm:px-4 py-3.5 text-right whitespace-nowrap space-x-1">
                        <button
                          ...
                          className="px-2.5 py-1.5 text-xs bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-bold transition-all dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700"
                        >
                          Editar
                        </button>
                        <button
                          onClick={() => onEliminarServicio(serv.id)}
                          className="px-2.5 py-1.5 text-xs bg-rose-50 text-rose-600 rounded-lg hover:bg-rose-100 font-bold transition-all dark:bg-rose-950/60 dark:text-rose-400 dark:hover:bg-rose-900/60"
                        >
                          Eliminar
                        </button>
                      </td>
      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-5 space-y-4 dark:bg-zinc-900 dark:border-zinc-800">
          ...
          <div className="pt-4 border-t border-gray-100 grid grid-cols-1 sm:grid-cols-2 gap-4 dark:border-zinc-800">
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm outline-none focus:border-black transition-all bg-gray-50/50 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-100 dark:focus:border-zinc-100"
              >
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm outline-none focus:border-black pl-7 transition-all bg-gray-50/50 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-100 dark:focus:border-zinc-100"
                />
                <span className="absolute left-2.5 top-2 text-xs text-gray-400 font-bold dark:text-zinc-500">
        ...
        {onGuardarReferidos && (
          <div className="pt-3 text-right">
            <button
              ...
              className="px-4 py-2 text-xs font-bold bg-black text-white rounded-xl hover:bg-gray-800 transition-all shadow-sm active:scale-95 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
            >
