        ...
        <form onSubmit={onSubmit} className="space-y-5">
              ...
              <button
                ...
                className={`py-3 px-4 rounded-xl border text-xs font-bold transition-all flex items-center justify-center gap-2 ${
                  tipoTurnoNuevo === 'laser'
                    ...
                    : 'bg-white border-gray-200 text-gray-600 hover:bg-rose-50/50 hover:border-rose-200 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-750'
                }`}
              >
              ...
              <button
                ...
                className={`py-3 px-4 rounded-xl border text-xs font-bold transition-all flex items-center justify-center gap-2 ${
                  tipoTurnoNuevo === 'general'
                    ...
                    : 'bg-white border-gray-200 text-gray-600 hover:bg-gray-50 hover:border-gray-300 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-750'
                }`}
              >
          ...
          {tipoTurnoNuevo === 'laser' ? (
            <div>
              ...
              <div className="border border-gray-200 rounded-2xl p-2.5 max-h-48 overflow-y-auto space-y-1.5 bg-gray-50/50 dark:bg-zinc-800/50 dark:border-zinc-800">
                      ...
                      >
                        <span className="flex items-center gap-2">
                          <input
                            ...
                            className="rounded border-gray-300 text-gray-900 focus:ring-gray-900 dark:border-zinc-600 dark:bg-zinc-700 dark:checked:bg-zinc-100"
                          />
          ...
          <div className="flex justify-end gap-2.5 pt-4 border-t border-gray-100 dark:border-zinc-800">
            ...
            <button
              type="submit"
              disabled={guardandoNuevoTurno}
              className="inline-flex items-center gap-2 px-5 py-2.5 text-xs font-semibold bg-gray-900 hover:bg-gray-800 text-white rounded-xl transition-all shadow-sm active:scale-95 disabled:opacity-50 disabled:pointer-events-none dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
            >
              {guardandoNuevoTurno ? (
                <>
